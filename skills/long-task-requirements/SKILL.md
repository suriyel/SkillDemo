...
Lite 挖掘后，进入 Step 7–11（DISPATCH quality sub-skill）→ Step 11b → Step 13（DISPATCH reviewer，`track=lite` 使 Group P = PASS-SKIPPED）→ Step 14（整段 SRS 单一审批）→ Step 15（DISPATCH finalize）。
